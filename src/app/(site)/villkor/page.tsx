...
import { VILLKOR_QUERY } from "@/sanity/lib/queries";
...
export default async function VillkorPage() {
  const { data: page } = await sanityFetch({ query: VILLKOR_QUERY });
  const heading = page?.heading || "Köpvillkor";
          ...
          <div className="space-y-10 text-foreground">
            {sections.map((section) => (
              <section key={section._key}>
                ...
                {section.body && (
                  <div className="text-muted-foreground space-y-3 [&_a]:text-primary [&_a]:hover:underline">
          ...
          <div className="space-y-10 text-foreground">
            ...
            <section>
              ...
              <p className="text-muted-foreground mt-3">
                ...
                specifikationer eller fått en tydlig personlig prägel – det
                gäller till exempel produkter med eget tryck eller egen
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                ...
                kontroll, till exempel force majeure, fel hos underleverantörer
                eller transportörer.
              </p>
            </section>
