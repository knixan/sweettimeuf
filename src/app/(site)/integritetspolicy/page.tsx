...
import { INTEGRITETSPOLICY_QUERY } from "@/sanity/lib/queries";
...
export default async function IntegritetspolicyPage() {
  const { data: page } = await sanityFetch({ query: INTEGRITETSPOLICY_QUERY });
  const heading = page?.heading || "Integritetspolicy";
          ...
          <div className="space-y-10 text-foreground">
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                ...
                (leverera varan och skicka faktura), hantera ditt konto och din
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                ...
                utgång. Kontouppgifter sparas så länge du har ett aktivt konto
                hos oss – du kan när som helst be oss radera ditt konto.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                ...
                underleverantörer som behövs för att driva sajten och leverera
                din beställning, till exempel vår e-postleverantör (för
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                ...
                enligt lagen om elektronisk kommunikation, men du informeras om
                dem här.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                ...
                ett klagomål till Integritetsskyddsmyndigheten (IMY) om du anser
                att vi behandlar dina uppgifter felaktigt.
              </p>
            </section>
